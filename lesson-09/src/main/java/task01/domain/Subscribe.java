...
public class Subscribe {
	...
	public Subscribe(Integer id, Integer userId, Integer magazineId, boolean subscribeStatus, Date subscribeDate, Integer subscribePeriod) {
		this.id = id;
		this.userId = userId;
	...
	public Subscribe(Integer userId, Integer magazineId, boolean subscribeStatus, Date subscribeDate, Integer subscribePeriod) {
		this.userId = userId;
		this.magazineId = magazineId;
		this.subscribeStatus = subscribeStatus;
		this.subscribeDate = subscribeDate;
	...
	public String toString() {
		return "Subscribe id = " + id + ", userId = " + userId + ", magazineId = " + magazineId + ", subscribeStatus = "
				+ subscribeStatus + ", subscribeDate = " + subscribeDate + ", subscribePeriod = " + subscribePeriod
				+ " months";
	}
